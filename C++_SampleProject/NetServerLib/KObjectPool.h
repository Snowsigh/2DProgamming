...
template<typename T>
void* volatile KObjectPool<T>::m_Pool[POOL_MAX_SIZE] = {};
template<typename T>
long long  volatile KObjectPool<T>::g_iHead = 0; // 생성 및 할당 인덱스
template<typename T>
long long  volatile KObjectPool<T>::g_iTail = 0; // 소멸 및 해제 인덱스