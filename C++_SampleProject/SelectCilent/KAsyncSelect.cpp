...
bool KAsyncSelect::Connect(HWND hWnd, int iprotocol, int iport, const char* ip)
{
	m_Sock = socket(AF_INET, iprotocol, 0);
	SOCKADDR_IN sa;
...
LRESULT KAsyncSelect::MsgProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch (msg)
	{
	case NETWORK_MSG:
