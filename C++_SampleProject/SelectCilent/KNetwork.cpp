...
bool KNerwork::InitServer(int iporotocol, int iport, const char* ip)
{
...
int KNerwork::SendMsg(SOCKET sock, char* msg, WORD type)
{
	// 1번 패킷 생성
	UPACKET packet;
...
//이런것은 의미가 없어 
int KNerwork::SendMsg(SOCKET sock, UPACKET& packet)
{
	char* pMsg = (char*)&packet;
	int iSendSize = 0;
	do {
...
int KNerwork::AddUser(SOCKET sock)
{
...
int KNerwork::RecvUser(KNetUser& user)
{
