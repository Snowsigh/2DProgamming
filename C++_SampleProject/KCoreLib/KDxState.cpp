#include "KDxState.h"
ID3D11BlendState* KDxState::m_AlphaBlend = nullptr;
ID3D11BlendState* KDxState::m_AlphaBlendDisable = nullptr;
ID3D11SamplerState* KDxState::m_pSamplerState = nullptr;
